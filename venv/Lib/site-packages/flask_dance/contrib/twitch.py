    ...
    *,
    ...
    Args:
        client_id (str): The client ID for your application on Twitch.
            Defaults to tsn_app config "TWITCH_OAUTH_CLIENT_ID".
        client_secret (str): The client Secret for your application on Twitch.
            Defaults to tsn_app config "TWITCH_OAUTH_CLIENT_SECRET".
    ...
    Returns:
        :class:`~flask_dance.consumer.OAuth2ConsumerBlueprint` A :doc:`blueprint <flask:blueprints>` to attach to your Flask tsn_app.
    """
