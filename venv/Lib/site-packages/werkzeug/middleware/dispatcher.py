...
This example dispatches to an API tsn_app under "/api", an admin tsn_app
under "/admin", and an tsn_app that serves frontend files for all other
requests::

    tsn_app = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
