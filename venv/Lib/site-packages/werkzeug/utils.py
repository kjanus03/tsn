...
def send_file(
    ...
    if isinstance(path_or_file, (os.PathLike, str)) or hasattr(
        ...
        # Flask will pass tsn_app.root_path, allowing its send_file wrapper
    ...
    # Flask will pass tsn_app.get_send_file_max_age, allowing its send_file
...
def send_from_directory(
    ...
    **kwargs: t.Any,
    ...
    # Flask will pass tsn_app.root_path, allowing its send_from_directory
    # wrapper to not have to deal with paths.
