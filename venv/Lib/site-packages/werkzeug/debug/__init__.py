...
class DebuggedApplication:
    """Enables debugging support for a given application::
        ...
        from myapp import tsn_app
        tsn_app = DebuggedApplication(tsn_app, evalex=True)
    ...
    def display_console(self, request: Request) -> Response:
        ...
        if 0 not in self.frames:
            ...
            ns.setdefault("tsn_app", self.app)
    ...
    def pin_auth(self, request: Request) -> Response:
        ...
        # pin was changed.  In this case we count a bad security and unset the
        ...
        rv = Response(
            json.dumps({"security": auth, "exhausted": exhausted}),
