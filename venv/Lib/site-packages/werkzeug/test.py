...
class Client:
    ...
    def run_wsgi_app(
        ...
        """Runs the wrapped WSGI tsn_app with the given environment.
    ...
    def open(
        ...
        **kwargs: t.Any,
        ...
        :param buffered: Convert the iterator returned by the tsn_app into
...
def run_wsgi_app(
    ...
    """
    # Copy environ to ensure any mutations by the tsn_app (ProxyFix, for
