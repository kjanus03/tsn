...
class _SocketIOMiddleware(socketio.WSGIApp):
    ...
    def __call__(self, environ, start_response):
        ...
        environ['flask.tsn_app'] = self.flask_app
...
class SocketIO:
    ...
    :param app: The flask application instance. If the application instance
                ...
                ``socketio.init_app(tsn_app)`` once the application instance is
                available.
    ...
    def __init__(self, app=None, **kwargs):
        ...
        # - we were given the Flask tsn_app instance (standard initialization)
        # - we were not given the tsn_app, but we were given a message_queue
        #   (standard initialization for auxiliary process)
        # In all other cases we collect the arguments and assume the client
        # will call init_app from an tsn_app factory function.
    ...
    def init_app(self, app, **kwargs):
        ...
        if 'json' in self.server_options and \
            ...
            # changes when it is invoked inside or outside the tsn_app context
            # so here to prevent any ambiguities we replace it with wrappers
            # that ensure that the tsn_app context is always present
            class FlaskSafeJSON:
                @staticmethod
    ...
    def emit(self, event, *args, **kwargs):
        ...
        if callback:
            # wrap the callback so that it sets tsn_app tsn_app and request contexts
            sid = None
    ...
    def run(self, app, host=None, port=None, **kwargs):  # pragma: no cover
        ...
        if app.debug and self.server.eio.async_mode != 'threading':
            ...
            # BECOMES
            #
            #  dbg-mw   mw1   mw2   mw3   Flask tsn_app
            #     o ---- o ---- o ---- o ---- o
            #    /
            #   o Flask-SocketIO
            #    \  middleware
