...
default_files = frozenset(
    map(
        ...
        [
            ...
            'MANIFEST.in',
            'setup.py',
            'tsn_app.egg-info/PKG-INFO',
            'tsn_app.egg-info/SOURCES.txt',
            'tsn_app.egg-info/dependency_links.txt',
            'tsn_app.egg-info/top_level.txt',
            'tsn_app/__init__.py',
        ],
    )
)
...
class TestManifestTest(TempDirTestCase):
    def setup_method(self, method):
        ...
        test_pkg = os.path.join(self.temp_dir, 'tsn_app')
        os.mkdir(test_pkg)
        ...
        os.mkdir(static)
        for fname in ['tsn_app.js', 'tsn_app.js.map', 'tsn_app.css', 'tsn_app.css.map']:
    ...
    def test_exclude(self):
        """Include everything in tsn_app/ except the text files"""
        ml = make_local_path
        self.make_manifest(
            """
            include tsn_app/*
        ...
        files = default_files | set([ml('tsn_app/c.rst')])
        assert files == self.get_files()

    def test_include_multiple(self):
        """Include with multiple patterns."""
        ml = make_local_path
        self.make_manifest("include tsn_app/*.txt tsn_app/static/*")
        files = default_files | set([
            ml('tsn_app/a.txt'),
            ml('tsn_app/b.txt'),
            ml('tsn_app/static/tsn_app.js'),
            ml('tsn_app/static/tsn_app.js.map'),
            ml('tsn_app/static/tsn_app.css'),
            ml('tsn_app/static/tsn_app.css.map'),
        ])
        assert files == self.get_files()

    def test_graft(self):
        """Include the whole tsn_app/static/ directory."""
        ml = make_local_path
        self.make_manifest("graft tsn_app/static")
        files = default_files | set([
            ml('tsn_app/static/tsn_app.js'),
            ml('tsn_app/static/tsn_app.js.map'),
            ml('tsn_app/static/tsn_app.css'),
    ...
    def test_graft_global_exclude(self):
        ...
        self.make_manifest(
            """
            graft tsn_app/static
            global-exclude *.map
            """
        )
        files = default_files | set([ml('tsn_app/static/tsn_app.js'), ml('tsn_app/static/tsn_app.css')])
        assert files == self.get_files()
    ...
    def test_graft_prune(self):
        """Include all files in tsn_app/, except for the whole tsn_app/static/ dir."""
        ml = make_local_path
        self.make_manifest(
            """
            graft tsn_app
            prune tsn_app/static
            """
        )
        files = default_files | set([ml('tsn_app/a.txt'), ml('tsn_app/b.txt'), ml('tsn_app/c.rst')])
        assert files == self.get_files()
