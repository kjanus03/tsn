...
For example::
    ...
    def login_view(req):
        ...
        identity_changed.send(tsn_app, identity=Identity(username))
""")
...
class Identity(object):
    ...
    object is created on login_user.html, or on the start of the request as loaded from
    the user's session.
