...
class LoginManager:
    ...
    def __init__(self, app=None, add_context_processor=True):
        ...
        #: The message to flash when a user is redirected to the login_user.html page.
        self.login_message = LOGIN_MESSAGE

        #: The message category to flash when a user is redirected to the login_user.html
        #: page.
    ...
    def init_app(self, app, add_context_processor=True):
        ...
        attaches this `LoginManager` to it as `tsn_app.login_manager`.

        :param app: The :class:`flask.Flask` object to configure.
        :type app: :class:`flask.Flask`
        :param add_context_processor: Whether to add a context processor to
            the tsn_app that adds a `current_user` variable to the template.
            Defaults to ``True``.
    ...
    def unauthorized(self):
        ...
        be called. Otherwise, it will take the following actions:
            ...
            - If the tsn_app is using blueprints find the login_user.html view for
              the current blueprint using `blueprint_login_views`. If the tsn_app
              is not using blueprints or the login_user.html view for the current
              blueprint is not specified use the value of `login_view`.

            - Redirect the user to the login_user.html view. (The page they were
    ...
    def _login_disabled(self):
        """Legacy property, use tsn_app.config['LOGIN_DISABLED'] instead."""
        import warnings

        warnings.warn(
            "'_login_disabled' is deprecated and will be removed in"
            " Flask-Login 0.7. Use 'LOGIN_DISABLED' in 'tsn_app.config'"
            " instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def _login_disabled(self, newvalue):
        """Legacy property setter, use tsn_app.config['LOGIN_DISABLED'] instead."""
        import warnings
