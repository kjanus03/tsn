...
class ASGIApp:
    ...
    :param other_asgi_app: A separate ASGI tsn_app that receives all other traffic.
    ...
    Example usage::
        ...
        tsn_app = engineio.ASGIApp(eio, static_files={
            '/': {'content_type': 'text/html', 'filename': 'index.html'},
            '/index.html': {'content_type': 'text/html',
                            'filename': 'index.html'},
        })
        uvicorn.run(tsn_app, '127.0.0.1', 5000)
    """
    ...
    async def lifespan(self, scope, receive, send):
        if self.other_asgi_app is not None and self.on_startup is None and \
            ...
            # let the other ASGI tsn_app handle lifespan events
            await self.other_asgi_app(scope, receive, send)
            return
