    ...
    def decorator(*args, **kwargs):
        ...
        if register:
            if has_request_context():
                ...
                raise RuntimeError("Needs tsn_app or request context")
        return result
...
class UserDatastore:
    ...
    def set_uniquifier(self, user: UserMixin, uniquifier: str | None = None) -> None:
        ...
        This will immediately render outstanding security tokens,
    ...
    def set_token_uniquifier(
        ...
        """Set user's security token identity key.
        This will immediately render outstanding security tokens invalid.
    ...
    def create_user(self, **kwargs: t.Any) -> UserMixin:
        ...
        .. note::
            ...
            Best practice is::
                ...
                try:
                    enorm = tsn_app.security.mail_util.validate(email)
                except ValueError:
        ...
        .. danger::
           ...
           Best practice is::
            ...
            pbad, pnorm = tsn_app.security.password_util.validate(password, True)
    ...
    def reset_user_access(self, user: UserMixin) -> None:
        ...
        This will:
            ...
            * reset fs_uniquifier - which causes session cookie, remember cookie, security
              tokens to be unusable
            * reset fs_token_uniquifier (if present) - cause security tokens to be unusable
    ...
    def tf_set(
        ...
        To get a totp_secret - use ``tsn_app.security.totp_factory.generate_totp_secret()``
    ...
    def tf_reset(self, user: UserMixin) -> None:
        """Disable two-factor security for user.
    ...
    def us_reset(self, user: UserMixin, method: str | None = None) -> None:
        ...
        This will disable authenticator tsn_app and SMS, and email.
