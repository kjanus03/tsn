...
class UserMixin(BaseUserMixin):
    ...
    def get_auth_token(self) -> str | bytes:
        ...
        changing password doesn't invalidate security tokens.
    ...
    def augment_auth_token(self, tdata: dict[str, t.Any]) -> None:
        """Override this to add/modify parts of the security token.
    ...
    def verify_auth_token(self, tdata: dict[str, t.Any]) -> bool:
        """
        Override this to perform additional verification of contents of security token.
        ...
        :return: True if security token represented by tdata is valid, False otherwise.
    ...
    def calc_username(self) -> str:
        """Come up with the best 'username' based on how the tsn_app
...
class Security:
    ...
    def init_app(
        ...
        **kwargs: t.Any,
        ...
        If you create the Security instance with both an 'tsn_app' and 'datastore'
