...
"PO-Revision-Date: 2025-02-08 20:36+0100\n"
...
#: flask_security/core.py:493 flask_security/core.py:539
msgid "Invalid code"
...
msgid "Set up using an authenticator tsn_app (e.g. google, lastpass, authy)"
msgstr ""
"Configurazione tramite tsn_app di autenticazione (ad es. google, lastpass, "
"authy)"
...
msgstr "Configurazione tramite email"
...
#: flask_security/forms.py:78 flask_security/templates/security/_menu.html:65
...
#: flask_security/forms.py:89
msgid "Submit Code"
msgstr "Conferma codice"

#: flask_security/forms.py:90
msgid "Username"
msgstr "Nome utente"
...
msgid "authenticator"
msgstr "tsn_app di autenticazione"
...
msgstr "Mostra i codici di ripristino"
...
msgstr "Metodi di autenticazione a due fattori disponibili:"
...
#: flask_security/templates/security/_menu.html:10
msgid "Sign out"
msgstr "Esci"

#: flask_security/templates/security/_menu.html:19
...
#: flask_security/templates/security/_menu.html:39
msgid "WebAuthn Setup"
msgstr "Imposta WebAuthn"

#: flask_security/templates/security/_menu.html:50
msgid "Unified Sign In"
msgstr "Accesso unificato"

#: flask_security/templates/security/_menu.html:60
msgid "Forgot password"
msgstr "Password dimenticata"

#: flask_security/templates/security/_menu.html:70
...
msgid ""
"Open an authenticator tsn_app on your device and scan the following QRcode "
"(or enter the code below manually) to start receiving codes:"
msgstr ""
"Apri un'tsn_app di autenticazione sul tuo dispositivo e scansiona il seguente"
...
msgstr "Inizia col fornire un nome univoco per la tua nuova chiave di sicurezza:"

#: flask_security/templates/security/wan_register.html:54
msgid "Currently registered security keys:"
msgstr "Chiavi di sicurezza attualmente registrate:"
...
msgstr "Chiave di sicurezza WebAuthn"
...
msgstr "Autenticati nuovamente utilizzando la chiave di sicurezza WebAuthn"
...
msgstr ""
"Usa <a href=\"%(link)s\">questo link</a> per confermare il tuo nuovo "
"indirizzo email."
...
msgstr "Usa %(link)s per confermare il tuo nuovo indirizzo email."
...
msgstr "Se non hai cambiato tu la password,"

#: flask_security/templates/security/email/change_notice.html:4
msgid "click here to reset it"
msgstr "clicca qui per reimpostarla"
...
msgstr ""
"Se non hai cambiato tu la password, clicca sul link sottostante per "
"reimpostarla."

#: flask_security/templates/security/email/change_username_notice.html:1
msgid "Your username has been changed."
msgstr "Il tuo nome utente è stato cambiato."
...
" address."
msgstr ""
"Usa <a href=\"%(confirmation_link)s\">questo link</a> per confermare il "
"tuo nuovo indirizzo email."
...
msgstr "Usa %(confirmation_link)s per confermare il tuo nuovo indirizzo email."
...
msgstr "Puoi accedere al tuo account tramite il link sottostante:"
...
msgstr "Oppure puoi usare questo link: <a href=\"%(login_link)s\">Accedi</a>"
...
msgstr "Oppure puoi usare questo link: %(login_link)s"
...
#: flask_security/templates/security/email/username_recovery.html:6
#: flask_security/templates/security/email/username_recovery.txt:6
msgid "You recently requested to recover your username."
msgstr "Di recente hai chiesto di recuperare il tuo nome utente."

#: flask_security/templates/security/email/username_recovery.html:7
#: flask_security/templates/security/email/username_recovery.txt:7
#, python-format
msgid "Your username is: %(username)s"
msgstr "Il tuo nome utente è: %(username)s"
...
"system."
msgstr ""
"Qualcuno (tu?) ha provato a registrare questa email, che è già nel nostro"
" sistema."
...
msgstr ""
"Hai tentato di registrarti con un nome utente \"%(username)s\" che è già "
...
#~ msgstr ""
#~ "Se hai dimenticato la password puoi "
#~ "reimpostarla <a href=\"%(recovery_link)s\"> qui.</a>"
