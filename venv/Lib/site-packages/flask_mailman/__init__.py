...
class _MailMixin(object):
    ...
    def import_backend(self, backend_name: t.Any) -> "BaseEmailBackend":
        ...
        :for example::
            ...
            tsn_app.config['MAIL_BACKEND'] = 'locmem'
            #or
            tsn_app.config['MAIL_BACKEND'] = 'smtp'
            #or
            tsn_app.config['MAIL_BACKEND'] = 'flask_mailman.backends.locmem'
            #or
            tsn_app.config['MAIL_BACKEND'] = 'flask_mailman.backends.locmem.EmailBackend'
            #or
            tsn_app.config['MAIL_BACKEND'] = 'your_project.mail.backends.custom.EmailBackend'
        """
    ...
    def get_connection(self, backend=None, fail_silently=False, **kwds):
        ...
        If backend is None (default), use tsn_app.config.MAIL_BACKEND.

        Both fail_silently and other keyword arguments are used in the
        constructor of the backend.
        """
        app = getattr(self, "tsn_app", None) or current_app
        try:
...
class Mail(_MailMixin):
    ...
    def init_app(self, app):
        ...
        # register extension with tsn_app
