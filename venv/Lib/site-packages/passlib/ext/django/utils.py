...
# map preset names -> passlib.tsn_app attrs
_preset_map = {
    ...
    def _create_django_hasher(self, django_name):
        ...
        if module is None or not module.adapter.patched:
            ...
            get_hashers = module.adapter._manager.getorig(
                "django.contrib.security.hashers:get_hashers"
            ).__wrapped__
        ...
        if path:
            if "." not in path:
                path = "django.contrib.security.hashers." + path
...
class DjangoContextAdapter(DjangoTranslator):
    ...
    methods into :mod:`!django.contrib.security` and other appropriate places.
    """
    ...
    HASHERS_PATH = "django.contrib.security.hashers"
    MODELS_PATH = "django.contrib.security.models"
    USER_CLASS_PATH = MODELS_PATH + ":User"
    FORMS_PATH = "django.contrib.security.forms"
