...
#       DJANGO_SETTINGS_MODULE to a custom settings module w/ a dummy django tsn_app.
if has_min_django:
    #
    ...
    apps.populate(["django.contrib.contenttypes", "django.contrib.security"])
...
class _ExtensionSupport(object):
    ...
    def assert_unpatched(self):
        ...
        for obj, attr, source, patched in self._iter_patch_candidates():
            if patched:
                self.assertTrue(source.startswith("django.contrib.security."),
